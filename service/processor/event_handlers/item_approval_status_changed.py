...
from processor.processor_common.server_handler import ServerCommunication
from processor.processor_common.config import get_resolved_secrets
from processor.processor_lib.event_abstraction import EventProcessor


class SyncsketchItemApprovalStatusChanged(EventProcessor):
